...
function SignIn() {
  ...
  const handleSignIn = async (e) => {
    ...
    setLoading(true);
    try{
      // to send post request to my back-end server from my front-end, to see what happens next go to index.js of backend
      let result = await axios.post(
        `${serverUrl}/api/auth/signin`, 
        // stateful variables.... already declared earlier
        {email, password},
  ...
  return(
    ...
    >
      ...
      {/* By default, a <button> inside a form without a specified type acts as type="submit".
        So when the user clicks this button, onSubmit={handleSignIn} is triggered. */}
